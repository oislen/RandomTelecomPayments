...
from .gen_trans_data import gen_trans_data
from .gen_user_data import gen_user_data
...
def gen_random_telecom_data(
    ...
    random_entity_counts = gen_random_entity_counts(
        user_obj=user_obj, transaction_timescale=programmeparams.transaction_timescale
    )
