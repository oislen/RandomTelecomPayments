...
def commandline_interface() -> dict[str, object]:
    ...
    parser.add_argument(
        ...
        dest="n_users",
        type=int,
        default=cons.default_n_users,
        help="Integer, the number of users to generate random telecom payments data for",
    )
    parser.add_argument(
        "--use_random_seed",
        action="store",
        ...
        type=int,
        default=cons.default_use_random_seed,
        choices=[0, 1],
        help="Integer, use a set random seed for reproducible results; must be either 0 or 1",
    )
    parser.add_argument(
        "--n_itr",
        action="store",
    ...
    parser.add_argument(
        ...
        dest="n_applications",
        type=int,
        default=cons.default_n_applications,
        help="Integer, the number of applications to generate random telecom payments data for",
    )
    parser.add_argument(
        "--registration_start_date",
        action="store",
        dest="registration_start_date",
        type=str,
        default=cons.default_registration_start_date,
        help="String, the start date for registrations",
    )
    parser.add_argument(
        "--registration_end_date",
        action="store",
        dest="registration_end_date",
        type=str,
        default=cons.default_registration_end_date,
        help="String, the end date for registrations",
    )
    parser.add_argument(
        "--transaction_start_date",
        action="store",
        dest="transaction_start_date",
        type=str,
        default=cons.default_transaction_start_date,
        help="String, the start date for transactions",
    )
    parser.add_argument(
        "--transaction_end_date",
        action="store",
        dest="transaction_end_date",
        type=str,
        default=cons.default_transaction_end_date,
        help="String, the end date for transactions",
    )
    parser.add_argument(
        "--is_release",
        action="store_true",
        dest="is_release",
        default=cons.default_is_release,
        help="Bool, whether the data being generated is for release",
    )
