...
obs_shared_idhashes = gen_shared_idhashes(
    idhashes=idhashes, prop_shared_idhashes=obs_prop_shared_idhashes
)
exp_shared_idhashes = {}
...
class TestGenSharedIdhashes(unittest.TestCase):
    ...
    def test_keys(self):
        self.assertEqual(
            list(self.exp_shared_idhashes.keys()), list(self.obs_shared_idhashes.keys())
        )

    def test_values(self):
        self.assertEqual(
            list(self.exp_shared_idhashes.values()),
            list(self.obs_shared_idhashes.values()),
        )
