...
class Test_input_error_handling(unittest.TestCase):
    ...
    def test_n_users_zero_raises(self):
        ...
        with self.assertRaises(ValueError):
            input_error_handling({"n_users": 0, "use_random_seed": 0, "n_itr": 1, "n_applications": 1})

    def test_n_users_negative_raises(self):
        """Negative n_users must raise ValueError."""
        with self.assertRaises(ValueError):
            input_error_handling({"n_users": -5, "use_random_seed": 0, "n_itr": 1, "n_applications": 1})

    def test_n_users_float_raises(self):
        """Float n_users must raise (beartype or ValueError)."""
        with self.assertRaises(Exception):
            input_error_handling({"n_users": 1.5, "use_random_seed": 0, "n_itr": 1, "n_applications": 1})
    ...
    def test_use_random_seed_invalid_value_raises(self):
        ...
        with self.assertRaises(ValueError):
            input_error_handling({"n_users": 10, "use_random_seed": 2, "n_itr": 1, "n_applications": 1})

    def test_use_random_seed_negative_raises(self):
        """use_random_seed = -1 must raise ValueError."""
        with self.assertRaises(ValueError):
            input_error_handling({"n_users": 10, "use_random_seed": -1, "n_itr": 1, "n_applications": 1})
    ...
    def test_n_itr_zero_raises(self):
        ...
        with self.assertRaises(ValueError):
            input_error_handling({"n_users": 10, "use_random_seed": 0, "n_itr": 0, "n_applications": 1})

    def test_n_itr_negative_raises(self):
        """Negative n_itr must raise ValueError."""
        with self.assertRaises(ValueError):
            input_error_handling({"n_users": 10, "use_random_seed": 0, "n_itr": -1, "n_applications": 1})
    ...
    def test_n_applications_zero_raises(self):
        ...
        with self.assertRaises(ValueError):
            input_error_handling({"n_users": 10, "use_random_seed": 0, "n_itr": 1, "n_applications": 0})

    def test_n_applications_negative_raises(self):
        """Negative n_applications must raise ValueError."""
        with self.assertRaises(ValueError):
            input_error_handling({"n_users": 10, "use_random_seed": 0, "n_itr": 1, "n_applications": -100})
    ...
    def test_error_message_contains_param_name_use_random_seed(self):
        ...
        with self.assertRaises(ValueError) as ctx:
            input_error_handling({"n_users": 1, "use_random_seed": 5, "n_itr": 1, "n_applications": 1})
    ...
    def test_error_message_contains_param_name_n_itr(self):
        ...
        with self.assertRaises(ValueError) as ctx:
            input_error_handling({"n_users": 1, "use_random_seed": 0, "n_itr": 0, "n_applications": 1})
    ...
    def test_error_message_contains_param_name_n_applications(self):
        ...
        with self.assertRaises(ValueError) as ctx:
            input_error_handling({"n_users": 1, "use_random_seed": 0, "n_itr": 1, "n_applications": 0})
