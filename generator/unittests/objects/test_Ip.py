...
ip_object = Ip(
    n_ip_hashes=exp_n_ip_hashes, fpath_countries_europe=fpath_countries_europe
)
...
class Test_Ip(unittest.TestCase):
    ...
    def test_type(self):
        ...
        self.assertEqual(
            type(self.obs_ip_shared_idhash_map_dict),
            type(self.exp_ip_shared_idhash_map_dict),
        )
    ...
    def test_len(self):
        ...
        self.assertEqual(
            len(self.obs_ip_shared_idhash_map_dict),
            len(self.exp_ip_shared_idhash_map_dict),
        )
    ...
    def test_keys(self):
        ...
        self.assertEqual(
            list(self.obs_ip_shared_idhash_map_dict.keys()),
            list(self.exp_ip_shared_idhash_map_dict.keys()),
        )
    ...
    def test_values(self):
        ...
        self.assertEqual(
            list(self.obs_ip_shared_idhash_map_dict.values()),
            list(self.exp_ip_shared_idhash_map_dict.values()),
        )
    ...
    def test_object(self):
        ...
        self.assertEqual(
            self.obs_ip_shared_idhash_map_dict, self.exp_ip_shared_idhash_map_dict
        )
