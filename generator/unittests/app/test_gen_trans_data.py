...
_fpath_countrycrimeindex = '.' + cons.fpath_countrycrimeindex.split(cons.fpath_repo_dir)[1]
...
class Test_gen_trans_data(unittest.TestCase):
    ...
    def test_transaction_status_in_valid_set(self):
        ...
        self.assertTrue(actual.issubset(_VALID_STATUSES), msg=f"Unexpected: {actual - _VALID_STATUSES}")
    ...
    def test_error_codes_in_valid_set(self):
        ...
        self.assertTrue(actual.issubset(_VALID_ERROR_CODES), msg=f"Unexpected: {actual - _VALID_ERROR_CODES}")
    ...
    def test_payment_method_in_valid_set(self):
        ...
        self.assertTrue(actual.issubset(_VALID_PAYMENT_METHODS), msg=f"Unexpected: {actual - _VALID_PAYMENT_METHODS}")
    ...
    def test_card_type_in_valid_set(self):
        ...
        self.assertTrue(actual.issubset(_VALID_CARD_TYPES), msg=f"Unexpected: {actual - _VALID_CARD_TYPES}")
    ...
    def test_payment_channel_in_valid_set(self):
        ...
        self.assertTrue(actual.issubset(_VALID_CHANNELS), msg=f"Unexpected: {actual - _VALID_CHANNELS}")
