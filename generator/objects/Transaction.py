...
class Transaction:
    ...
    def __init__(
        self,
        n_transaction_hashes: int | np.int64,
        start_date: str,
        end_date: str,
    ):
        """
        ...
        self.transaction_hashes_amounts_dict = self.gen_transaction_amounts(
            transaction_hashes=self.transaction_hashes, loc=0, scale=2
        )
    ...
    def gen_transaction_status(
        ...
        transaction_hashes_status_dict = dict(
            zip(transaction_hashes, transaction_status, strict=False)
        )
    ...
    def gen_transaction_amounts(
        ...
        trans_prices_dict = dict(
            zip(transaction_hashes, round_trans_amount(trans_prices), strict=False)
        )
