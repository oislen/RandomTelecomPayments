...
qaUids = qa.Uids(data=data, show_logs=True, show_plots=True)
qaTransactions = qa.Transactions(data=data, show_logs=True, show_plots=True)
qaCards = qa.Cards(data=data, show_logs=True, show_plots=True)
qaIps = qa.Ips(data=data, show_logs=True, show_plots=True)
```
