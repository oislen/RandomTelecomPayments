...
nunique_user_ids_per_uid = data.groupby(by='uid', dropna=False, as_index=False).agg({'userid':'nunique'}).sort_values(by=['userid'])
...
nunique_reg_date_per_uid = data.groupby(by='uid', dropna=False, as_index=False).agg({'registration_date':'nunique'}).sort_values(by=['registration_date'])
...
nunique_reg_country_per_uid = data.groupby(by='uid', dropna=False, as_index=False).agg({'registration_country_code':'nunique'}).sort_values(by=['registration_country_code'])
...
nunique_email_domains_per_uid = data.groupby(by='uid', dropna=False, as_index=False).agg({'email_domain':'nunique'}).sort_values(by=['email_domain'])
