...
from report.qmarkdown.utilities.plotting import lift_plot
...
# load component data
user_comp_data_fpath=os.path.join(data_report_dir, 'user_comp_data.csv')
...
anomaly_data_users_fpath=os.path.join(data_report_dir, 'user_anomaly_data.csv')
...
lift_plot(col='predict_proba', target='black_list_users', data=valid_data, order = None, cut = 10)
```